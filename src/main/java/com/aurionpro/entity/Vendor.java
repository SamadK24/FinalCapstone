...
@Entity
@Table(name = "vendors", uniqueConstraints = { @UniqueConstraint(columnNames = { "organization_id", "name" }) })
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
...
public class Vendor {
	...
	// Optional Cloudinary document public IDs (comma-separated or moved to a
